...
The default image is `ghcr.io/iuliandita/honcho-dashboard:1.6.3`. Release image tags omit the leading `v`
even though Git tags include it: use image tag `1.6.3` for Git tag `v1.6.3`.
